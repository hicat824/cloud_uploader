...
server="op-01.gzproduction.com"
repository="kd-recog"
base_image="base"
base_image_version="12.1-cudnn8.9.0-ubuntu20.04-py38-trt8.6.1-torch.none-libtorch2.1.0-vpf11.0-r1"
...
echo "docker build -f ./Dockerfile ${jenkins_root_project_dir} \
                   -t kd-bd02.kuandeng.com/cs/$target_docker_name:$2 \
                   --build-arg BASE_IMAGE=$base_image \
                   --build-arg BASE_IMAGE_VERSION=$base_image_version \
                   --build-arg JENKINS_PROJECT_FOLDER_NAME=$current_project_folder_name \
                   || exit 5"

ali_docker_respository="kd-bd02.kuandeng.com/cs"
DOCKER_BUILDKIT=0 docker build --rm -f ./Dockerfile_gpu ${jenkins_root_project_dir} \
             -t $ali_docker_respository/$target_docker_name:$2 \
             --build-arg BASE_IMAGE=$base_image \
             --build-arg BASE_IMAGE_VERSION=$base_image_version \
             --build-arg JENKINS_PROJECT_FOLDER_NAME=$current_project_folder_name \
             || exit 5
